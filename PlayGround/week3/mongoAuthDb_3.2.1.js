...
async function main() {
  await mongoose.connect("mongodb+srv://vaibhavbajpayee2109:btv8U5TYzlFeqMUG@cluster0.itw4lsa.mongodb.net/userapp");
}
...
app.post("/signup", async function(req, res) {
    ...
    if(isUserExist) {
      ...
      const user = new User({name: name, email: email, password: password, kaitari: 'not in schema, so not saving in DB'});
      user.save();
